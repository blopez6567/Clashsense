...
const LoginPage: React.FC = () => {
  ...
  React.useEffect(() => {
    document.title = 'Login | Origin Finance';
  }, []);
        ...
        <div className="bg-white dark:bg-slate-800 py-8 px-4 shadow-sm sm:rounded-lg sm:px-10 border border-slate-200 dark:border-slate-700">
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="appearance-none block w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-md shadow-sm placeholder-slate-400 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 bg-white dark:bg-slate-800 text-slate-900 dark:text-white sm:text-sm"
                />
              </div>
            </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              ...
              <div>
                <Button variant="outline" fullWidth className="flex items-center justify-center">
                  <svg className="h-5 w-5 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512" fill="currentColor">
